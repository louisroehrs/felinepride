...
import com.felinepride.app.graphql.api.resources.ApiKeyDirector;
...
public class GraphQLEndpoint extends SimpleGraphQLServlet {
    ...
    protected GraphQLContext createContext(Optional<HttpServletRequest> request, Optional<HttpServletResponse> response) {
        ...
        if (!currentUser.isAuthenticated()) {
            ...
            if (ApiKeyDirector.isFPAdminKeyValid(authorizationHeader)) {
                List<String> globalRoles = new ArrayList<String>();
                globalRoles.add("FPAdmin");
                //User adminUser = new User();
                //adminUser.setUserName("FPAdminKey")
//                        .setGlobalRoles(globalRoles);
        ...
        return null;
             ...
             /*
                ...
                if (commandPermissions.requireFPAdminAccess()) {
